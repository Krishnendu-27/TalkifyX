    ...
    >
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {/* <div
              className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-bold tracking-wider mb-6 ${
                isDark
            ...
            <div
              className={`mt-8 flex items-center gap-4 text-sm font-medium ${theme.textMuted}`}
            >
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div
                    ...
                    className={`w-10 h-10 rounded-full border-2 ${
                      isDark
                        ? "border-slate-950 bg-slate-800"
                        : "border-slate-50 bg-slate-200"
                    }`}
                  />
                ))}
              </div>
