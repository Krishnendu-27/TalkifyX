...
const Loading = () => {
    ...
    return (
        <div className={`fixed inset-0 z-50 flex flex-col items-center justify-center transition-colors duration-300 ${theme.bg}`}>
            ...
            >
                ...
                {/* Main Icon */}
                <div className={`relative z-10 p-4 rounded-2xl shadow-xl border ${theme.sidebarBg} ${theme.divider}`}>
                    <motion.div
                        animate={{ rotate: 360 }}
