...
const RegisterPage = () => {
  ...
  return (
    ...
    >
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-cyan-500/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className={isDark ? "text-slate-400" : "text-slate-500"}>
            Join us and start chatting globally.
          </p>
        </div>

        <RegisterForm theme={theme} onClose={() => {}} />
